...
int main()
{
	...
	Player p_2 = { 1, 50.f, 40.f, 35.54f, {35.5f, 67.45f, 100.003f} }; //Initialize Player Struct and intiinalize LocationVector struct inside Player Struch Initialization
